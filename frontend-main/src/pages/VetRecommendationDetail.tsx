...
export const VetRecommendationDetail = () => {
  ...
  const handleUpdateRecommendation = () => {
    ...
    navigate(`/vet/recommendation/${id}`, {
      state: {
        request,
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
          ...
          <div className={styles.infoSection}>
            ...
            <div className={styles.infoGrid}>
              ...
              <div className={styles.infoItem}>
                ...
                <span className={styles.infoValue}>{request.petName}</span>
              </div>
              <div className={styles.infoItem}>
              ...
              <div className={styles.infoItem}>
                ...
                <span className={styles.infoValue}>{request.gender === 'male' ? 'Мужской' : 'Женский'}</span>
              </div>
              <div className={styles.infoItem}>
                <span className={styles.infoLabel}>Дата рождения:</span>
                <span className={styles.infoValue}>{request.birthDate || 'Не указано'}</span>
              </div>
              <div className={styles.infoItem}>
                <span className={styles.infoLabel}>ID паспорта:</span>
                <span className={styles.infoValue}>{request.passportId || 'Не указано'}</span>
              </div>
            </div>
          </div>
        )}
        ...
        {request && (
          <div className={styles.infoSection}>
            <h2 className={styles.sectionTitle}>Запрос</h2>
            <div className={styles.requestInfo}>
              <div className={styles.infoItem}>
                <span className={styles.infoLabel}>Активность:</span>
                <span className={styles.infoValue}>{request.activityTypeName}</span>
              </div>
              <div className={styles.infoItem}>
                <span className={styles.infoLabel}>Симптомы:</span>
        ...
        <div className={styles.subtitleSection}>
          <p className={styles.subtitle}>
            Ниже представлена <span className={styles.highlightText}>полноценная оценка</span>, сформированная на основе доступных данных для питомца <span className={styles.highlightText}>«{petName}»</span>
          </p>
        </div>
